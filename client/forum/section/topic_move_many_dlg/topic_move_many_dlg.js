...
N.wire.on(module.apiPath, function show_topic_move_many_dlg(options) {
  ...
  return N.io.rpc('forum.section.topic.move_many.tree', { section_hid: params.section_hid_from }).then(res => {
    $dialog = $(N.runtime.render(module.apiPath, _.assign({}, params, res)));
