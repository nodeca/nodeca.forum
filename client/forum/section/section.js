...
// - mark_cut_ts:      date when topic list was last fetched (required for mark all read)
//
let pageState = {};
let scrollable_list;
...
N.wire.once('navigate.done:' + module.apiPath, function page_once() {
  ...
  N.wire.on(module.apiPath + ':subscription', function section_subscription(data) {
    ...
    return Promise.resolve()
      ...
      .then(() => N.io.rpc('forum.section.change_subscription', { section_hid: hid, type: params.subscription }))
      .then(() => {
