...
module.exports = function (N) {
  ...
  N.wire.on('init:jobs', function register_forum_topics_search_update_with_posts() {
    function TaskTemplate(queue, ids = []) {
      ...
      Queue.GroupTemplate.call(this, queue, tasks);
    }

    inherits(TaskTemplate, Queue.GroupTemplate);

    TaskTemplate.serializableFields = Queue.GroupTemplate.serializableFields;
